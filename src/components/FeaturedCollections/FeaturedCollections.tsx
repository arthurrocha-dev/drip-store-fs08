    ...
    <>
      <div className={styles.CollectionsContainer}>
        ...
        <div className={styles.CardsList}>
          <CollectionCard discount={40} title='Novo Drop Supreme'urlImg="img/tShirtCollection.png"/>
          <CollectionCard discount={25} title='Coleção Adidas' urlImg="img/tennisCollection.png"/>
          <CollectionCard discount={15} title='Novo Beats Bass' urlImg="img/headPhoneCollection.png"/>
        </div>
