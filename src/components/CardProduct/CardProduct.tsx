...
export const CardProduct:React.FC<CardProductProps> = ({urlImg, name, price, discountValue=0, department}) => {
    return(
            ...
            { discountValue > 0 ? (
                <>
                    ...
                    <div className={styles.DiscountPercentage}>
                        { discountValue && price ? Math.round((discountValue / price) * 100) : ''}% OFF
                    </div>
                </>
            ) : (
                <div className={styles.CardProductContainerBottom}>
