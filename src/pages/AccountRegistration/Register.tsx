            ...
            <div className={style.LoginTitle}>
                ...
                <div className={style.LoginPageFormButton}>
                    <section className={style.NewsLetter}>
                        <input type="checkbox" />
                        <a className={style.NewsLetter}>Quero receber por email ofertas e novidades das lojas da Digital Store. A frequência de envios pode variar de acordo com a interação do cliente.</a>
                    </section>
